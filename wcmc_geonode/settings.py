...
from wcmc_geonode import get_version
from wcmc_geonode.celeryapp import app  # flake8: noqa
import djcelery
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'wcmc_geonode.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'wcmc_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, wcmc_geonode',
